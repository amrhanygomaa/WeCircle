        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <h3 style={{ ...sectionTitleStyle, borderBottom: "none", marginBottom: 0, paddingBottom: 0 }}>
              ...
              {activeTab === "ops" && t('' as any)}
              {activeTab === "academic" && t('' as any)}
          ...
          {activeTab === "academic" && (
            <div className="setting-section fade-in">
              <div style={{ marginBottom: "32px" }}>
                <label style={{ ...labelStyle, marginBottom: "16px", display: "block", fontSize: "14px" }}>{t('' as any)}</label>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                  ...
                  >
                    ...
                    <div style={{ textAlign: isAr ? "right" : "left", flex: 1 }}>
                      <p style={{ fontWeight: 800, color: "var(--glass-text-primary)", fontSize: "16px", marginBottom: "2px" }}>{t('' as any)}</p>
                      <p style={{ fontSize: "12px", color: "var(--glass-text-secondary)", lineHeight: 1.4 }}>{t('' as any)}</p>
                    </div>
                  </div>
              ...
              <div className="premium-card" style={{ padding: "24px", borderRadius: "24px", border: "1px solid var(--glass-border)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px", flexDirection: isAr ? "row-reverse" : "row" }}>
                  <div>
                    <label style={{ ...labelStyle, marginBottom: "2px", display: "block", fontSize: "14px" }}>{t('' as any)}</label>

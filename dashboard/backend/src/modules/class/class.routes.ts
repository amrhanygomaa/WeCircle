...
router.post("/", requireAuth, tenantScope, roleGuard([Role.SUPER_ADMIN]), createClass);
router.delete("/:id", requireAuth, tenantScope, roleGuard([Role.SUPER_ADMIN]), deleteClass);
